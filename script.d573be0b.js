...
window.onload = function () {
  ...
  var h = document.documentElement,
      ...
      st = 'scrollTop',
      sh = 'scrollHeight';
  scroller.onScroll(function (position) {
    scroll = (h[st] || b[st]) / ((h[sh] || b[sh]) - h.clientHeight);
    progress.style['transform'] = "scaleX(".concat(scroll, ")");
  });
